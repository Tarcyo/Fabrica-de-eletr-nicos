 ...
 * @author Tarcyo
 */
public class FabricaDaApple extends FabricaGenerica implements FabricaDeEletronicosGenerica {

    public FabricaDaApple(String endereco, int metaProducao, int capacidade) {
        super(endereco, metaProducao, capacidade);
    }
    ...
    public Celular criaCelular(String modelo, float tamanhoDeTela, String resolucaoDeTela, float capacidadeArmazenamento, float ram, float resolucaoCamera, float capacidadeBateria) {
        Celular celular = new CelularDaApple(modelo, tamanhoDeTela, resolucaoDeTela, capacidadeArmazenamento, ram, resolucaoCamera, capacidadeBateria);
    ...
    public Notebook criaNotebook(String modelo, boolean touchScreen, double memoriaRam, double armazenamento, String processador, double polegadas, String placaDeVídeo, boolean entradaRj45) {
        Notebook notebook = new NotebookDaApple(modelo, touchScreen, memoriaRam, armazenamento, processador, polegadas, placaDeVídeo, entradaRj45);
    ...
    public RelogioEletronico criaRelogio(double tamanhoDeTela, double quantBateria, String modelo, String pulseira, TipoCargaRelogio tipoCargaRelogio) {
        RelogioEletronico relogio = new RelogioDaApple(tamanhoDeTela, quantBateria, modelo, pulseira, tipoCargaRelogio);
